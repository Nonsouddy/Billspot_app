  ...
  return (
    <section className='GuideMain' >
        <div className='Guide'>
          ...
          <div className='Discover'>Discover a world of possibilities and take charge of your bill payments with our user-friendly tools and customized solutions.</div>
          <div className='ttrt'>
            ...
            <div >
              <Image className='GuideImg' src={GuideSvg} alt='' />
            </div>
          </div>
        </div>
      </section>
